...
const TRANSLATIONS = {
  en: {
    ...
    nav_contact:     'Contact',
    /* INDEX */
    eyebrow_index:   'Minecraft Plugin · Survival 1.21.X · All-in-One',
    ...
    cmd_afkzoneview: 'Shows information and status of the configured AFK zones.',
    cmd_spawnzoneview: 'Shows information and status of the configured spawn protection zone.',
    ...
    cmd_nightvision:         'Toggles night vision for the player. Allows seeing in complete darkness without needing a potion. Alias: /sc.',
    cmd_resetcooldown:       'Resets the cooldown of the specified item for a player. Supports notchapple, goldenapple and enderpearl.',
    cmd_settings:            'Opens the personal settings menu. Allows the player to configure individual preferences such as scoreboard visibility, private messages, and other toggleable options.',
    cmd_customenchant_book:  'Gives a custom enchanted book of the specified type. Available types: 3x3 (3×3 block break area) and teefeller (tree feller).',
    cmd_customenchant_enchant:'Applies a custom enchantment directly to the held item. Available types: 3x3 (3×3 block break area) and teefeller (tree feller).',
    ...
    /* HOLOGRAM SYSTEM */
    sec_hologram:       'Hologram System',
    cmd_holocreate:     "Creates a new hologram at the executor's current position with the specified name and initial text line. The hologram persists across server restarts.",
    cmd_holodelete:     'Permanently deletes an existing hologram by name, removing it from the world and from the saved configuration.',
    cmd_holotp:         'Teleports the executor to the location of the specified hologram. Useful for quickly finding or inspecting holograms placed anywhere in the world.',
    cmd_holomove:       "Moves an existing hologram to the executor's current position. The hologram's content is preserved; only its location changes.",
    cmd_hololist:       'Lists all holograms currently configured on the server, showing their name, world, coordinates and number of lines.',
    cmd_holoaddline:    'Appends a new text line to the bottom of an existing hologram. Supports color codes and PlaceholderAPI variables.',
    cmd_holoremoveline: 'Removes a specific line from a hologram by its line number (starting at 1). Tab-completes with the available line numbers for the selected hologram.',
    /* AFKZONE HOLOGRAM & CLAN PVP */
    cmd_afkzonehologram:"Toggles the per-player private hologram inside the AFK zone. When enabled, each player in the zone sees only their own status hologram showing time spent, rewards collected and time until next reward. Uses Paper's entity visibility API to keep holograms private.",
    cmd_clanpvp:        'Toggles friendly fire within the clan. When enabled, clan members can damage each other. Only the leader or officers can use this. Notifies all online members of the change.',
    ...
    /* v1.0.3 CHANGELOG */
    cl_v103_date: 'April 2026',
    cl_v103_desc: 'Major quality-of-life update adding <strong>custom enchantments</strong>, new GUI systems, player settings and significant message improvements across all three languages.',
    cl_improvements: 'Improvements',
    cl_103_settings: 'Personal settings menu for each player',
    cl_103_stats: 'Multiple stats implemented with GUI menu',
    cl_103_enchants: '3x3 Pickaxe and Treecapitator Axe, added to book mode',
    cl_103_rtpgui: 'GUI interface implemented for /rtp',
    cl_103_cooldown: 'Reset cooldown for golden apples, Notch apples and ender pearls',
    cl_103_clangui: 'Clan GUI has been improved',
    cl_103_protgui: 'Protection GUI has been improved',
    cl_103_licensing: 'Licensing system has been improved',
    cl_103_messages: 'Significantly improved in all three languages, more messages added for greater customisability',
    cl_103_viewfix: 'Fixed view areas for these commands',
    cl_103_spawnerfix: 'Fixed a bug with stacked spawners',
    cl_103_combatfix: 'Players can no longer place protections whilst in combat',
    cl_103_minorfix: 'Minor bugs fixed',
  },
  es: {
    nav_home:        'Inicio',
    ...
    eyebrow_index:   'Plugin de Minecraft · Survival 1.21.X · Todo en Uno',
    ...
    cmd_afkzoneview: 'Muestra información y estado de las zonas AFK configuradas.',
    cmd_spawnzoneview: 'Muestra información y estado de la zona de protección del spawn.',
    cmd_kothview: 'Muestra información y estado de las zonas KOTH configuradas.',
    ...
    cmd_nightvision:         'Activa o desactiva la visión nocturna para el jugador. Permite ver en la oscuridad completa sin necesidad de poción. Alias: /sc.',
    cmd_resetcooldown:       'Reinicia el cooldown del ítem especificado para un jugador. Compatible con notchapple, goldenapple y enderpearl.',
    cmd_settings:            'Abre el menú de configuración personal. Permite al jugador configurar preferencias individuales como visibilidad del marcador, mensajes privados y otras opciones activables.',
    cmd_customenchant_book:  'Da un libro encantado personalizado del tipo indicado. Tipos disponibles: 3x3 (ruptura de bloques en área 3×3) y teefeller (tala de árboles completos).',
    cmd_customenchant_enchant:'Aplica un encantamiento personalizado directamente al ítem en mano. Tipos disponibles: 3x3 (ruptura de bloques en área 3×3) y teefeller (tala de árboles completos).',
    ...
    /* HOLOGRAM SYSTEM */
    sec_hologram:       'Sistema de Hologramas',
    cmd_holocreate:     'Crea un nuevo holograma en la posición actual del ejecutor con el nombre y texto inicial indicados. El holograma persiste entre reinicios del servidor.',
    cmd_holodelete:     'Elimina permanentemente un holograma existente por nombre, borrándolo del mundo y de la configuración guardada.',
    cmd_holotp:         'Teletransporta al ejecutor a la ubicación del holograma especificado. Útil para encontrar rápidamente hologramas colocados en cualquier parte del mundo.',
    cmd_holomove:       'Mueve un holograma existente a la posición actual del ejecutor. El contenido del holograma se conserva; solo cambia su ubicación.',
    cmd_hololist:       'Lista todos los hologramas configurados en el servidor, mostrando su nombre, mundo, coordenadas y número de líneas.',
    cmd_holoaddline:    'Añade una nueva línea de texto al final de un holograma existente. Admite códigos de color y variables de PlaceholderAPI.',
    cmd_holoremoveline: 'Elimina una línea específica de un holograma por su número de línea (empezando por 1). El autocompletado muestra los números de línea disponibles.',
    cmd_afkzonehologram:"Activa o desactiva el holograma privado por jugador dentro de la zona AFK. Cuando está activo, cada jugador en la zona ve solo su propio holograma de estado mostrando tiempo en zona, recompensas obtenidas y tiempo hasta la siguiente recompensa.",
    cmd_clanpvp:        'Activa o desactiva el fuego amigo dentro del clan. Cuando está activado, los miembros del clan pueden hacerse daño entre sí. Solo el líder u oficiales pueden usarlo. Notifica a todos los miembros en línea del cambio.',
    ...
    /* v1.0.3 CHANGELOG */
    cl_v103_date: 'Abril 2026',
    cl_v103_desc: 'Gran actualización de calidad de vida que añade <strong>encantamientos personalizados</strong>, nuevos sistemas de GUI, configuraciones de jugador y mejoras significativas en los mensajes de los tres idiomas.',
    cl_improvements: 'Mejoras',
    cl_103_settings: 'Menú de configuración personal para cada jugador',
    cl_103_stats: 'Múltiples estadísticas implementadas con menú GUI',
    cl_103_enchants: 'Pico 3x3 y Hacha Talaárboles, añadidos al modo libro',
    cl_103_rtpgui: 'Interfaz GUI implementada para /rtp',
    cl_103_cooldown: 'Reinicia el cooldown de manzanas doradas, manzanas Notch y perlas de ender',
    cl_103_clangui: 'La GUI de clanes ha sido mejorada',
    cl_103_protgui: 'La GUI de protecciones ha sido mejorada',
    cl_103_licensing: 'El sistema de licencias ha sido mejorado',
    cl_103_messages: 'Significativamente mejorados en los tres idiomas, más mensajes añadidos para mayor personalización',
    cl_103_viewfix: 'Arregladas las áreas de vista de estos comandos',
    cl_103_spawnerfix: 'Corregido un error con los spawners apilados',
    cl_103_combatfix: 'Los jugadores ya no pueden colocar protecciones mientras están en combate',
    cl_103_minorfix: 'Errores menores corregidos',
    /* BUY */
    buy_btn: 'Pincha aquí para obtenerlo en BuiltByBit',
    buy_note: 'Disponible ahora en BuiltByBit. Haz clic en el botón de arriba para comprarlo.',
  },
  fr: {
    ...
    nav_installation:'Installation',
    nav_contact:     'Contact',
    eyebrow_index:   'Plugin Minecraft · Survival 1.21.X · Tout-en-Un',
    ...
    cmd_afkzoneview: "Affiche les informations et l'état des zones AFK configurées.",
    cmd_spawnzoneview: "Affiche les informations et l'état de la zone de protection du spawn.",
    cmd_kothview: "Affiche les informations et l'état des zones KOTH configurées.",
    ...
    cmd_nightvision:         'Active ou désactive la vision nocturne pour le joueur. Permet de voir dans l\'obscurité totale sans potion. Alias : /sc.',
    cmd_resetcooldown:       'Réinitialise le cooldown de l\'objet spécifié pour un joueur. Compatible avec notchapple, goldenapple et enderpearl.',
    cmd_settings:            'Ouvre le menu de paramètres personnels. Permet au joueur de configurer ses préférences individuelles telles que la visibilité du tableau de bord, les messages privés et d\'autres options activables.',
    cmd_customenchant_book:  'Donne un livre enchanté personnalisé du type indiqué. Types disponibles : 3x3 (rupture de blocs en zone 3×3) et teefeller (abattage d\'arbres entiers).',
    cmd_customenchant_enchant:'Applique un enchantement personnalisé directement sur l\'objet en main. Types disponibles : 3x3 (rupture de blocs en zone 3×3) et teefeller (abattage d\'arbres entiers).',
    /* HOLOGRAM SYSTEM */
    sec_hologram:       'Système d\'Hologrammes',
    cmd_holocreate:     'Crée un nouvel hologramme à la position actuelle de l\'exécuteur avec le nom et le texte initial indiqués. L\'hologramme persiste entre les redémarrages du serveur.',
    cmd_holodelete:     'Supprime définitivement un hologramme existant par son nom, le retirant du monde et de la configuration sauvegardée.',
    cmd_holotp:         'Téléporte l\'exécuteur vers l\'emplacement de l\'hologramme spécifié. Utile pour trouver rapidement des hologrammes placés n\'importe où dans le monde.',
    cmd_holomove:       'Déplace un hologramme existant vers la position actuelle de l\'exécuteur. Le contenu de l\'hologramme est préservé ; seule sa position change.',
    cmd_hololist:       'Liste tous les hologrammes configurés sur le serveur, affichant leur nom, monde, coordonnées et nombre de lignes.',
    cmd_holoaddline:    'Ajoute une nouvelle ligne de texte en bas d\'un hologramme existant. Supporte les codes couleur et les variables PlaceholderAPI.',
    cmd_holoremoveline: 'Supprime une ligne spécifique d\'un hologramme par son numéro de ligne (à partir de 1). La complétion automatique affiche les numéros disponibles.',
    cmd_afkzonehologram:'Active ou désactive l\'hologramme privé par joueur dans la zone AFK. Quand activé, chaque joueur voit uniquement son propre hologramme de statut indiquant le temps passé, les récompenses obtenues et le délai avant la prochaine récompense.',
    cmd_clanpvp:        'Active ou désactive le tir ami au sein du clan. Quand activé, les membres du clan peuvent se blesser entre eux. Seuls le chef ou les officiers peuvent l\'utiliser. Notifie tous les membres en ligne du changement.',
    ...
    /* v1.0.3 CHANGELOG */
    cl_v103_date: 'Avril 2026',
    cl_v103_desc: 'Mise à jour majeure de qualité de vie ajoutant des <strong>enchantements personnalisés</strong>, de nouveaux systèmes GUI, des paramètres joueur et des améliorations significatives des messages dans les trois langues.',
    cl_improvements: 'Améliorations',
    cl_103_settings: 'Menu de paramètres personnels pour chaque joueur',
    cl_103_stats: 'Plusieurs statistiques implémentées avec un menu GUI',
    cl_103_enchants: 'Pioche 3x3 et Hache Bûcheron, ajoutées au mode livre',
    cl_103_rtpgui: 'Interface GUI implémentée pour /rtp',
    cl_103_cooldown: 'Réinitialise le cooldown des pommes dorées, pommes Notch et perles de l\'End',
    cl_103_clangui: 'L\'interface GUI des clans a été améliorée',
    cl_103_protgui: 'L\'interface GUI des protections a été améliorée',
    cl_103_licensing: 'Le système de licences a été amélioré',
    cl_103_messages: 'Significativement améliorés dans les trois langues, plus de messages ajoutés pour une meilleure personnalisation',
    cl_103_viewfix: 'Zones d\'affichage corrigées pour ces commandes',
    cl_103_spawnerfix: 'Correction d\'un bug avec les spawners empilés',
    cl_103_combatfix: 'Les joueurs ne peuvent plus placer de protections en combat',
    cl_103_minorfix: 'Corrections de bugs mineurs',
    /* BUY */
    buy_btn: 'Cliquez ici pour l\'obtenir sur BuiltByBit',
    buy_note: 'Disponible maintenant sur BuiltByBit. Cliquez sur le bouton ci-dessus pour acheter.',
  }
