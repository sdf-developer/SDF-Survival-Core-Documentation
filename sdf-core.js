...
const TRANSLATIONS = {
  en: {
    ...
    /* CONFIGS PAGE */
    configs_eyebrow:       'Plugin Configuration Files',
    configs_title_1:       'CONFIG',
    configs_title_2:       'FILES',
    configs_sub:           'All configuration files for SDF Survival Core — fully editable YAML files auto-generated on first run.',
    configs_sub_strong:    'SDF Survival Core',
    cfg_section_main:      'Main Configuration',
    cfg_section_clan:      'Clan System',
    cfg_section_koth:      'KOTH System',
    cfg_section_crates:    'Crates System',
    cfg_section_protections:'Protections System',
    cfg_section_lang:      'Language Files',
    cfg_badge_main:        'Main Config',
    cfg_badge_clan:        'Clan System',
    cfg_badge_koth:        'KOTH Events',
    cfg_badge_crates:      'Crates & Keys',
    cfg_badge_protections: 'Zone Protections',
    /* NEW COMMANDS - PS complete + missing */
    cmd_psmain:         'Opens the protection help menu. Lists all available subcommands for the land protection system.',
    cmd_psget:          'Obtains a protection block of the specified type. Required to place a new protection zone.',
    cmd_pshome:         'Teleports the player to one of their protections. If they have multiple, shows a clickable list.',
    cmd_psaddowner:     'Adds a player as co-owner of the current protection with full management rights.',
    cmd_psremoveowner:  "Removes a player's co-owner rights from the current protection.",
    cmd_psflag:         'Opens the flag panel for the current protection. Allows toggling PvP, mob kills, item drops and other zone rules.',
    cmd_pssethome:      'Sets the teleport home point inside your protection. Used by /ps home.',
    cmd_pslock:         'Locks or unlocks the protection so nobody except the owner and co-owners can enter.',
    cmd_psview:         'Visualizes nearby protections using particle borders, making zone boundaries visible.',
    cmd_pshide:         'Hides or shows the physical protection block. The protection remains active even when hidden.',
    cmd_psmerge:        'Merges two adjacent protections that you own into a single larger zone.',
    cmd_psgive:         'Gives a protection block of the specified type to the target player. Admin-only command.',
    cmd_psviewhome:     "Shows all protections of the specified player with clickable teleport links.",
    cmd_pssetowner:     'Transfers ownership of the current protection to another player. Admin action.',
    cmd_homes:          'Opens the homes GUI menu showing all saved homes. Clicking a home teleports to it. Staff can pass a player name.',
    cmd_kits:           'Alias of /kit. Opens the available kits GUI menu where players can claim kits within their cooldown.',
    cmd_balancetop:     'Shows the ranking of the richest players on the server. Alias of /baltop.',
    cmd_alert:          'Alias of /broadcast. Sends an announcement to all players on the server.',
    cmd_v:              'Short alias for /vanish. Toggles staff invisibility instantly.',
    cmd_ss:             'Internal screenshare command. Initiates the screenshare/freeze protocol for a suspected cheater.',
    cmd_gmc:            'Switches to Creative mode instantly. Alias for /gm 1.',
    cmd_gms:            'Switches to Survival mode instantly. Alias for /gm 0.',
    cmd_gma:            'Switches to Adventure mode instantly. Alias for /gm 2.',
    cmd_gmspec:         'Switches to Spectator mode instantly. Alias for /gm 3.',
    cmd_kitreset:       'Resets the cooldown of a specific kit for the target player, allowing them to claim it again immediately.',
    cmd_geoip:          'Shows the country of origin of a player\'s connection. Useful for detecting VPN abuse or alt accounts.',
    cmd_day:            'Sets the time to day in the current world or the specified world.',
    cmd_night:          'Sets the time to night in the current world or the specified world.',
    cmd_sun:            'Clears the weather in the current world or the specified world.',
    cmd_rain:           'Sets the weather to rain in the current world or the specified world.',
    /* PRINCIPAL.HTML store keys */
    brand_tagline:   'Plugin Studio',
    nav_browse:      'Browse',
    nav_all:         'All Plugins',
    nav_support:     'Support',
    topbar_store:    'Store',
    topbar_status:   '1 Plugin Available',
    masthead_eyebrow:'Premium Minecraft Plugins',
    masthead_desc:   'Hand-crafted plugins built for performance, <strong>deeply configurable</strong> and actively maintained. One plugin to replace many.',
    hero_dim_line:   'SDF PLUGIN STUDIO · EST. 2026',
    mstat_plugin:    'Plugin',
    mstat_systems:   'Systems',
    mstat_version:   'Version',
    mstat_from:      'From',
    band_label:      'Now Available',
    band_body:       '<strong>SDF Survival Core</strong> — the complete survival server framework is live. Clans, KOTH, economy, combat and more.',
    band_cta:        'View Plugin →',
    section_title:   'Available Plugins',
    section_note:    '1 available · 5 coming soon',
    card_core_desc:  'A complete survival server framework: clans, KOTH, economy, combat, bounties, scoreboards and much more — all in a single plugin.',
    card_core_f1:    '16+ integrated systems — KOTH, Clans, Economy, Combat, Crates & more',
    card_core_f2:    'Fully configurable YAML with auto-generated configs on first launch',
    card_core_f3:    'Multi-language support: English, Spanish and French built-in',
    card_core_f4:    'MySQL support + Lunar Client, LuckPerms, PAPI & WorldGuard integration',
    price_label:     'Launch price',
    card_view:       'View Plugin',
    card_buy:        'Get Now',
    card_specs:      'Specs',
    spec_version:    'MC Version',
    spec_server:     'Server',
    spec_commands:   'Commands',
    ...
    cfg_copied:            'Copied',
    /* DEPS SPLIT */
    deps_required_label:   'Required',
    deps_optional_label:   'Optional',
  },
  es: {
    nav_home:        'Inicio',
    ...
    /* CONFIGS PAGE */
    configs_eyebrow:       'Archivos de Configuración del Plugin',
    configs_title_1:       'ARCHIVOS',
    configs_title_2:       'CONFIG',
    configs_sub:           'Todos los archivos de configuración de SDF Survival Core — archivos YAML editables generados automáticamente en el primer arranque.',
    configs_sub_strong:    'SDF Survival Core',
    cfg_section_main:      'Configuración Principal',
    cfg_section_clan:      'Sistema de Clanes',
    cfg_section_koth:      'Sistema KOTH',
    cfg_section_crates:    'Sistema de Crates',
    cfg_section_protections:'Sistema de Protecciones',
    cfg_section_lang:      'Archivos de Idioma',
    cfg_badge_main:        'Config Principal',
    cfg_badge_clan:        'Sistema de Clanes',
    cfg_badge_koth:        'Eventos KOTH',
    cfg_badge_crates:      'Crates y Llaves',
    cfg_badge_protections: 'Protecciones de Zona',
    /* NEW COMMANDS - PS completo + faltantes */
    cmd_psmain:         'Abre el menú de ayuda de protecciones. Lista todos los subcomandos disponibles del sistema de protección de terrenos.',
    cmd_psget:          'Obtiene un bloque de protección del tipo indicado. Necesario para colocar una nueva zona protegida.',
    cmd_pshome:         'Teletransporta al jugador a una de sus protecciones. Si tiene varias, muestra una lista clicable.',
    cmd_psaddowner:     'Añade a un jugador como co-propietario de la protección actual con derechos completos de gestión.',
    cmd_psremoveowner:  'Elimina los derechos de co-propietario de un jugador en la protección actual.',
    cmd_psflag:         'Abre el panel de banderas de la protección actual. Permite activar/desactivar PvP, matar mobs, drops y otras reglas.',
    cmd_pssethome:      'Establece el punto de teletransporte dentro de tu protección. Usado por /ps home.',
    cmd_pslock:         'Bloquea o desbloquea la protección para que nadie excepto el propietario y co-propietarios pueda entrar.',
    cmd_psview:         'Visualiza las protecciones cercanas con bordes de partículas, haciendo visibles los límites de zona.',
    cmd_pshide:         'Oculta o muestra el bloque físico de la protección. La protección sigue activa aunque esté oculta.',
    cmd_psmerge:        'Fusiona dos protecciones adyacentes que poseas en una única zona más grande.',
    cmd_psgive:         'Da un bloque de protección del tipo indicado al jugador objetivo. Comando exclusivo de administrador.',
    cmd_psviewhome:     'Muestra todas las protecciones del jugador indicado con enlaces de teletransporte clicables.',
    cmd_pssetowner:     'Transfiere la propiedad de la protección actual a otro jugador. Acción de administrador.',
    cmd_homes:          'Abre el menú GUI de homes con todos los homes guardados. Clicar en uno teletransporta. El staff puede indicar nombre de jugador.',
    cmd_kits:           'Alias de /kit. Abre el menú GUI de kits disponibles donde los jugadores pueden reclamar sus kits.',
    cmd_balancetop:     'Muestra el ranking de los jugadores más ricos del servidor. Alias de /baltop.',
    cmd_alert:          'Alias de /broadcast. Envía un anuncio a todos los jugadores del servidor.',
    cmd_v:              'Alias corto de /vanish. Activa o desactiva la invisibilidad de staff al instante.',
    cmd_ss:             'Comando interno de screenshare. Inicia el protocolo de screenshare/congelación para un posible tramposo.',
    cmd_gmc:            'Cambia a modo Creativo al instante. Alias de /gm 1.',
    cmd_gms:            'Cambia a modo Supervivencia al instante. Alias de /gm 0.',
    cmd_gma:            'Cambia a modo Aventura al instante. Alias de /gm 2.',
    cmd_gmspec:         'Cambia a modo Espectador al instante. Alias de /gm 3.',
    cmd_kitreset:       'Reinicia el cooldown de un kit específico para el jugador objetivo, permitiéndole reclamarlo de nuevo.',
    cmd_geoip:          'Muestra el país de origen de la conexión de un jugador. Útil para detectar abuso de VPN o cuentas alternativas.',
    cmd_day:            'Establece la hora a día en el mundo actual o en el mundo indicado.',
    cmd_night:          'Establece la hora a noche en el mundo actual o en el mundo indicado.',
    cmd_sun:            'Despeja el tiempo en el mundo actual o en el mundo indicado.',
    cmd_rain:           'Establece lluvia en el mundo actual o en el mundo indicado.',
    /* PRINCIPAL.HTML claves tienda */
    brand_tagline:   'Estudio de Plugins',
    nav_browse:      'Explorar',
    nav_all:         'Todos los Plugins',
    nav_support:     'Soporte',
    topbar_store:    'Tienda',
    topbar_status:   '1 Plugin Disponible',
    masthead_eyebrow:'Plugins Premium de Minecraft',
    masthead_desc:   'Plugins artesanales construidos para el rendimiento, <strong>altamente configurables</strong> y mantenidos activamente. Un plugin para sustituir a muchos.',
    hero_dim_line:   'SDF PLUGIN STUDIO · EST. 2026',
    mstat_plugin:    'Plugin',
    mstat_systems:   'Sistemas',
    mstat_version:   'Versión',
    mstat_from:      'Desde',
    band_label:      'Disponible Ahora',
    band_body:       '<strong>SDF Survival Core</strong> — el framework completo para servidores survival ya está disponible. Clanes, KOTH, economía, combate y más.',
    band_cta:        'Ver Plugin →',
    section_title:   'Plugins Disponibles',
    section_note:    '1 disponible · 5 próximamente',
    card_core_desc:  'Un framework completo para servidores survival: clanes, KOTH, economía, combate, recompensas, marcadores y mucho más — en un solo plugin.',
    card_core_f1:    '16+ sistemas integrados — KOTH, Clanes, Economía, Combate, Crates y más',
    card_core_f2:    'YAML completamente configurable con configs generadas automáticamente',
    card_core_f3:    'Soporte multiidioma: Inglés, Español y Francés integrados',
    card_core_f4:    'Soporte MySQL + integración con Lunar Client, LuckPerms, PAPI y WorldGuard',
    price_label:     'Precio de lanzamiento',
    card_view:       'Ver Plugin',
    card_buy:        'Obtener',
    card_specs:      'Especificaciones',
    spec_version:    'Versión MC',
    spec_server:     'Servidor',
    spec_commands:   'Comandos',
    spec_systems:    'Sistemas',
    spec_database:   'Base de datos',
    spec_license:    'Licencia',
    soon_text:       'Próximamente',
    badge_optional:  'Opcional',
    buy_f6:          'Soporte por Discord',
  ...
  fr: {
    ...
    /* CONFIGS PAGE */
    configs_eyebrow:       'Fichiers de Configuration du Plugin',
    configs_title_1:       'FICHIERS',
    configs_title_2:       'CONFIG',
    configs_sub:           'Tous les fichiers de configuration de SDF Survival Core — fichiers YAML éditables générés automatiquement au premier lancement.',
    configs_sub_strong:    'SDF Survival Core',
    cfg_section_main:      'Configuration Principale',
    cfg_section_clan:      'Système de Clans',
    cfg_section_koth:      'Système KOTH',
    cfg_section_crates:    'Système de Caisses',
    cfg_section_protections:'Système de Protections',
    cfg_section_lang:      'Fichiers de Langue',
    cfg_badge_main:        'Config Principale',
    cfg_badge_clan:        'Système de Clans',
    cfg_badge_koth:        'Événements KOTH',
    cfg_badge_crates:      'Caisses & Clés',
    cfg_badge_protections: 'Protections de Zone',
    /* NOUVELLES COMMANDES - PS complet + manquantes */
    cmd_psmain:         'Ouvre le menu d\'aide des protections. Liste tous les sous-commandes disponibles du système de protection de terrain.',
    cmd_psget:          'Obtient un bloc de protection du type indiqué. Nécessaire pour placer une nouvelle zone protégée.',
    cmd_pshome:         'Téléporte le joueur vers l\'une de ses protections. S\'il en a plusieurs, affiche une liste cliquable.',
    cmd_psaddowner:     'Ajoute un joueur en tant que co-propriétaire de la protection actuelle avec des droits de gestion complets.',
    cmd_psremoveowner:  'Supprime les droits de co-propriétaire d\'un joueur dans la protection actuelle.',
    cmd_psflag:         'Ouvre le panneau de drapeaux de la protection actuelle. Permet d\'activer/désactiver le PvP, les mobs, les drops et autres règles.',
    cmd_pssethome:      'Définit le point de téléportation à l\'intérieur de votre protection. Utilisé par /ps home.',
    cmd_pslock:         'Verrouille ou déverrouille la protection pour que personne sauf le propriétaire et co-propriétaires ne puisse entrer.',
    cmd_psview:         'Visualise les protections proches avec des bordures de particules, rendant les limites de zone visibles.',
    cmd_pshide:         'Cache ou affiche le bloc physique de protection. La protection reste active même lorsqu\'elle est cachée.',
    cmd_psmerge:        'Fusionne deux protections adjacentes que vous possédez en une seule zone plus grande.',
    cmd_psgive:         'Donne un bloc de protection du type indiqué au joueur cible. Commande réservée aux administrateurs.',
    cmd_psviewhome:     'Affiche toutes les protections du joueur indiqué avec des liens de téléportation cliquables.',
    cmd_pssetowner:     'Transfère la propriété de la protection actuelle à un autre joueur. Action d\'administrateur.',
    cmd_homes:          'Ouvre le menu GUI des homes avec tous les homes sauvegardés. Cliquer sur l\'un d\'eux téléporte. Le staff peut indiquer un nom de joueur.',
    cmd_kits:           'Alias de /kit. Ouvre le menu GUI des kits disponibles où les joueurs peuvent réclamer leurs kits.',
    cmd_balancetop:     'Affiche le classement des joueurs les plus riches du serveur. Alias de /baltop.',
    cmd_alert:          'Alias de /broadcast. Envoie une annonce à tous les joueurs du serveur.',
    cmd_v:              'Alias court de /vanish. Active ou désactive l\'invisibilité du staff instantanément.',
    cmd_ss:             'Commande interne de screenshare. Initie le protocole screenshare/gel pour un tricheur présumé.',
    cmd_gmc:            'Passe en mode Créatif instantanément. Alias de /gm 1.',
    cmd_gms:            'Passe en mode Survie instantanément. Alias de /gm 0.',
    cmd_gma:            'Passe en mode Aventure instantanément. Alias de /gm 2.',
    cmd_gmspec:         'Passe en mode Spectateur instantanément. Alias de /gm 3.',
    cmd_kitreset:       'Réinitialise le cooldown d\'un kit spécifique pour le joueur cible, lui permettant de le réclamer à nouveau.',
    cmd_geoip:          'Affiche le pays d\'origine de la connexion d\'un joueur. Utile pour détecter l\'abus de VPN ou les comptes alternatifs.',
    cmd_day:            'Définit l\'heure à jour dans le monde actuel ou dans le monde indiqué.',
    cmd_night:          'Définit l\'heure à nuit dans le monde actuel ou dans le monde indiqué.',
    cmd_sun:            'Dégage le temps dans le monde actuel ou dans le monde indiqué.',
    cmd_rain:           'Définit la pluie dans le monde actuel ou dans le monde indiqué.',
    /* PRINCIPAL.HTML clés boutique */
    brand_tagline:   'Studio de Plugins',
    nav_browse:      'Parcourir',
    nav_all:         'Tous les Plugins',
    nav_support:     'Support',
    topbar_store:    'Boutique',
    topbar_status:   '1 Plugin Disponible',
    masthead_eyebrow:'Plugins Minecraft Premium',
    masthead_desc:   'Plugins artisanaux conçus pour la performance, <strong>hautement configurables</strong> et activement maintenus. Un plugin pour en remplacer plusieurs.',
    hero_dim_line:   'SDF PLUGIN STUDIO · EST. 2026',
    mstat_plugin:    'Plugin',
    mstat_systems:   'Systèmes',
    mstat_version:   'Version',
    mstat_from:      'À partir de',
    band_label:      'Disponible Maintenant',
    band_body:       '<strong>SDF Survival Core</strong> — le framework complet pour serveurs survival est disponible. Clans, KOTH, économie, combat et plus.',
    band_cta:        'Voir le Plugin →',
    section_title:   'Plugins Disponibles',
    section_note:    '1 disponible · 5 à venir',
    card_core_desc:  'Un framework survival complet : clans, KOTH, économie, combat, primes, tableaux de score et bien plus — en un seul plugin.',
    card_core_f1:    '16+ systèmes intégrés — KOTH, Clans, Économie, Combat, Caisses et plus',
    card_core_f2:    'YAML entièrement configurable avec configs auto-générées au premier lancement',
    card_core_f3:    'Support multilingue : Anglais, Espagnol et Français intégrés',
    card_core_f4:    'Support MySQL + intégration Lunar Client, LuckPerms, PAPI et WorldGuard',
    price_label:     'Prix de lancement',
    card_view:       'Voir le Plugin',
    card_buy:        'Obtenir',
    card_specs:      'Caractéristiques',
    spec_version:    'Version MC',
    spec_server:     'Serveur',
    spec_commands:   'Commandes',
    spec_systems:    'Systèmes',
    spec_database:   'Base de données',
    spec_license:    'Licence',
    soon_text:       'Bientôt disponible',
